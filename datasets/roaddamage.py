...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 21 15:15:41 2021
...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "train", root / "annotations_coco" / 'train_half_80.json'),
        "val": (root / "train", root / "annotations_coco" / 'val_half_20.json'),
        "test": (root / "test", root / "annotations_coco" / 'test.json'),
        "trainall": (root / "train", root / "annotations_coco" / 'train.json'),
