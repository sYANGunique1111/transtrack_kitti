...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  7 18:25:29 2021
...
def build(image_set, args):
    ...
    mode = 'instances'
    if args.dataset_file == 'kitti_origin':
        PATHS = {
            "train": (root / "train", root / "annotations_origin" / 'train_half.json'),
            "val": (root / "train", root / "annotations_origin" / 'val_half.json'),
            "trainall": (root / "train", root / "annotations_origin" / 'train.json'),
